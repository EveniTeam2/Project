...
namespace Unit.GameScene.Boards
{
    ...
    public class BlockMatcher : IBlockMatcher
    {
        ...
        {
            var targetX = direction.x > 0 ? startPosition.x + _blockGap : direction.x < 0 ? startPosition.x - _blockGap : startPosition.x;
            var targetY = direction.y > 0 ? startPosition.y + _blockGap : direction.y < 0 ? startPosition.y - _blockGap : startPosition.y;
