...
namespace Unit.GameScene.Boards
{
    ...
    public class BlockGenerator : IBlockGenerator
    {
        ...
        public BlockGenerator(List<BlockSo> blockSos, IBlockPool blockPool,
            Dictionary<Tuple<float, float>, Block> tiles, Canvas canvas, RectTransform blockPanel, Vector2 blockSize,
        ...
        public BlockSo GetRandomValidBlock(Dictionary<Tuple<float, float>, Block> blockDic,
        ...
        private int CheckDirection(Dictionary<Tuple<float, float>, Block> blockDic, Tuple<float, float> position,
            BlockSo blockTypeInfo, Vector2 direction)
        {
            var matchCount = 0;
