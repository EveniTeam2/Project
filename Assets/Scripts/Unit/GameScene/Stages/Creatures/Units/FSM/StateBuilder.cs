...
namespace Unit.GameScene.Stages.Creatures.Units.FSM {
    public static class StateBuilder {
        ...
        private static BaseState BuildState(StateData data, Transform tr, BattleSystem ba, HealthSystem he, MovementSystem mo, Animator an, StateMachine sm) {
            Action<StateType, int> enter = data.OnEnter != null ? data.OnEnter.GetStateAction(tr, ba, he, mo, an, sm).OnAct : null;
            Action<StateType, int> exit = data.OnExit != null ? data.OnExit.GetStateAction(tr, ba, he, mo, an, sm).OnAct : null;
            ...
            FullState full = data.OnEveryAction?.GetFullState(tr, ba, he, mo, an, sm) ?? null;
