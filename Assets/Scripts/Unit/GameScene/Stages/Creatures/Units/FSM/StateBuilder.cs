...
namespace Unit.GameScene.Stages.Creatures.Units.FSM {
    public static class StateBuilder {
        public static StateMachine BuildState(Creature target, StateDataDTO data) {
        ...
        private static BaseState BuildState(StateMachine sm, StateData data) {
            ...
            Func<Creature, bool> condition = data.Condition != null
            ...
            if ((int)data.AnimParameterEnums >= Enum.GetValues(typeof(AnimationParameterEnums)).Length) {
                ...
                return new BaseState(data.StateType, hash, sm, enter, exit, update, fixedUpdate, condition);
            }

            return new BaseState(data.StateType, 0, sm, enter, exit, update, fixedUpdate, condition);
        }
